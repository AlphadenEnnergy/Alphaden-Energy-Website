...
const EPCIData = () => {
  return (
    <div className="mt-2 w-full max-w-5xl mb-5 h-auto flex flex-col justify-start items-start text-left text-xs text-gray-500 leading-loose px-8 md:px-0 md:h-auto">
      ...
      (SPDC) for their Assa North Ohaji South Gas Development Project, which
      includes the Well Bay Area Construction, Project Fabrication, Internal &
      External roads, Perimeter Fencing, Residential & Industrial Infrastructure
      as well as other developments that make up the Assa North/Ohaji South
