...
const Data = () => {
  return (
    <section className="px-20 flex justify-center items-center w-full ">
      <div className="w-full max-w-5xl mb-5 h-auto px-8 md:px-0 md:h-auto">
        ...
        <div className="mt-8">
          <h2 className="text-xl text-gray-700 font-semibold mt-5">What information do we collect?</h2>
          <p className="leading-loose text-gray-500">
            Mi tincidunt elit, id quisque ligula ac diam, amet. Vel etiam
        ...
        <div>
          <h2 className="text-xl text-gray-700 font-semibold mt-5">Do we use cookies and other tracking technologies?</h2>
          <p className="leading-loose text-gray-500">
            Mi tincidunt elit, id quisque ligula ac diam, amet. Vel etiam
            suspendisse morbi eleifend faucibus eget vestibulum felis. Dictum
            quis montes, sit sit. Tellus aliquam enim urna, etiam. Mauris
        ...
        <div>
          <h2 className="text-xl text-gray-700 font-semibold mt-5">How long do we keep your information?</h2>
          <p className="leading-loose text-gray-500">
            Mi tincidunt elit, id quisque ligula ac diam, amet. Vel etiam
            suspendisse morbi eleifend faucibus eget vestibulum felis. Dictum
        ...
        <div>
          <h2 className="text-xl text-gray-700 font-semibold mt-5">How do we keep your information safe?</h2>
          <p className="leading-loose text-gray-500">
            Mi tincidunt elit, id quisque ligula ac diam, amet. Vel etiam
            suspendisse morbi eleifend faucibus eget vestibulum felis. Dictum
            quis montes, sit sit. In turpis vel et quam imperdiet. Ipsum molestie
        ...
        <div>
          <h2 className="text-xl text-gray-700 font-semibold mt-5">What are your privacy rights?</h2>
          <p className="leading-loose text-gray-500">
            Mi tincidunt elit, id quisque ligula ac diam, amet. Vel etiam
            suspendisse morbi eleifend faucibus eget vestibulum felis. Dictum
            quis montes, sit sit. In turpis vel et quam imperdiet. Ipsum molestie
        ...
        <div>
          <h2 className="text-xl text-gray-700 font-semibold mt-5">How can you contact us about this policy?</h2>
          <p className="leading-loose text-gray-500">
