  ...
  return (
    <div className="px-5 bg-primary text-white flex flex-col items-center justify-center md:px-0">
      <div className="px-2 w-full max-w-7xl my-12 flex justify-between">
        ...
        <div className="hidden w-full max-w-xl md:grid grid-cols-2 md:grid-cols-3 text-gray-300 md:space-x-3">
          <div className="flex flex-col space-y-3 text-sm md:text-md">
          ...
          <div className="flex flex-col space-y-3 text-sm md:text-md">
            ...
            <Link href={"/epci"}>EPCI</Link>
            <Link href={"/sipca"}>
              System Intergration, Process Control and Automation
            </Link>
        ...
        <div className="w-full max-w-xl flex md:hidden">
          <div className="w-1/2">
            <div className="flex flex-col space-y-3 text-sm md:text-md">
              <Link href={"/"} className="text-gray-400 md:text-white">
                Legal{" "}
            ...
            <div className="flex flex-col space-y-3 text-sm md:text-md mt-4">
              <Link href={"/about-us"} className="text-gray-400 md:text-white">
                About Us
              </Link>
              <Link href={"/about-us"}>What we do</Link>
          ...
          <div className="flex flex-col w-1/2 space-y-3 text-sm md:text-md">
            <Link href={"/"} className="text-gray-400 md:text-white">
              Our Services
            </Link>
            <Link href={"/epci"}>EPCI</Link>
