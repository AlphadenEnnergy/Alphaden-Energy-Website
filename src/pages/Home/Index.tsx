      ...
      <div
        className={`pulse bg ${
          currentNumber === 1
            ...
            ? "hero-1"
            : "hero-2"
        } w-full flex-col items-center justify-between text-sm md:text-md lg:flex transition delay-700 duration-300 ease-in-ou`}
      >
        <div className="w-full flex flex-col justify-center items-center">
          <div className="max-w-7xl my-40 h-40 flex flex-col justify-center items-start px-8 md:px-0 md:h-80">
        ...
        <div className="flex justify-end items-end w-full  max-w-7xl px-8 md:px-0">
